    ...
    public function up(): void
    {
        ...
        $defaultMonitoringApproaches = [
            1 => [
                ...
                'pt' => 'Monitorizar pedidos de alteração, colocações em produção, revisões de arquitetura e o inventário de ativos.',
            ],
            2 => [
                ...
                'pt' => 'Monitorizar análises de vulnerabilidades, boletins de segurança, avisos CERT e alertas de fabricantes ou fornecedores.',
            ],
            3 => [
                ...
                'pt' => 'Monitorizar alertas do SOC, tickets de incidente, registos de segurança e relatórios pós-incidente.',
            ],
            4 => [
                ...
                'pt' => 'Monitorizar atualizações regulamentares, análises jurídicas, obrigações contratuais e comunicações das autoridades.',
            ],
            5 => [
                ...
                'pt' => 'Monitorizar avaliações de fornecedores, SLA, notificações de serviço e incidentes que afetem terceiros críticos.',
            ],
            6 => [
                ...
                'pt' => 'Monitorizar alterações organizacionais, revisões de processos, alterações de pessoal e atualizações de responsabilidades.',
            ],
            7 => [
                ...
                'pt' => 'Monitorizar constatações de auditoria, planos de ação, resultados de avaliação e controlos não conformes.',
            ],
            8 => [
                ...
                'pt' => 'Monitorizar inteligência de ameaças, feeds externos, relatórios setoriais e campanhas ativas relevantes.',
            ],
            9 => [
                ...
                'pt' => 'Monitorizar projetos de adoção tecnológica, dossiês de arquitetura, pedidos de investimento e iniciativas-piloto.',
            ],
            10 => [
                ...
                'pt' => 'Monitorizar o calendário de revisão, prazos de governação, lembretes de conformidade e planos de controlo periódicos.',
            ],
        ];
