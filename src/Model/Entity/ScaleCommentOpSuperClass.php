 ...
 */
class ScaleCommentOpSuperClass extends AbstractEntity
{
    ...
    /**
     * @var \Monarc\Core\Model\Entity\ScaleOp
     *
     * @ORM\ManyToOne(targetEntity="Monarc\Core\Model\Entity\ScaleOp", cascade={"persist"})
     * @ORM\JoinColumns({
