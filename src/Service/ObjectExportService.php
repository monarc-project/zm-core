...
class ObjectExportService extends AbstractService
{
    ...
    public function importFromArray($data, $anr, $modeImport = 'merge', &$objectsCache = [])
    {
         ...
         * TODO: Refactor/optimise the method.
         */

        if (isset($data['object'][$nameFiledKey], $objectsCache['objects'][$data['object'][$nameFiledKey]])) {
            return $objectsCache['objects'][$data['object'][$nameFiledKey]];
        }
