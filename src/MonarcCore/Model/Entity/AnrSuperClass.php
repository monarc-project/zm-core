...
class AnrSuperClass extends AbstractEntity
{
     ...
     *     joinColumns={@ORM\JoinColumn(name="anrs_string_id", referencedColumnName="label_translation_id")},
     ...
     * @ORM\JoinTable(name="translation_language",
     *     joinColumns={@ORM\JoinColumn(name="anrs_string_id", referencedColumnName="description_translation_id")},
     *     inverseJoinColumns={@ORM\JoinColumn(name="translation_id", referencedColumnName="id")})
     *
     */
